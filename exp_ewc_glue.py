...
Original file is located at
    https://colab.research.google.com/drive/1yFbAPujRYzLI6zYyJ3RtrFld4Msz3TbF
...
!pip install git+https://github.com/newcodevelop/transformers

!rm -rf transformers models runs glue_data

!git clone https://github.com/newcodevelop/transformers
